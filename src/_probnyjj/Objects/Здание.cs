...
namespace IIS._probnyjj
{
    ...
    public class Здание : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS._probnyjj.Город fГород;
        ...
        /// воЭтаж.
        /// </summary>
        // *** Start programmer edit section *** (Здание.воЭтаж CustomAttributes)

        // *** End programmer edit section *** (Здание.воЭтаж CustomAttributes)
        private int воЭтаж
        {
            get
            {
                // *** Start programmer edit section *** (Здание.воЭтаж Get start)

                // *** End programmer edit section *** (Здание.воЭтаж Get start)
                int result = this.fвоЭтаж;
                // *** Start programmer edit section *** (Здание.воЭтаж Get end)

                // *** End programmer edit section *** (Здание.воЭтаж Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Здание.воЭтаж Set start)

                // *** End programmer edit section *** (Здание.воЭтаж Set start)
                this.fвоЭтаж = value;
                // *** Start programmer edit section *** (Здание.воЭтаж Set end)

                // *** End programmer edit section *** (Здание.воЭтаж Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Город"})]
        [NotNull()]
        public virtual IIS._probnyjj.Город Город
        {
            get
            {
                ...
                IIS._probnyjj.Город result = this.fГород;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗданиеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеE", typeof(IIS._probnyjj.Здание));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗданиеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗданиеL", typeof(IIS._probnyjj.Здание));
                }
            }
        }
    }
